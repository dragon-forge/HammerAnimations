		...
		implements ICompoundSerializable
{
	...
	public void deserializeNBT(HolderLookup.Provider provider, CompoundTag tag)
	{
		...
		if(tag.contains("Last", Tag.TAG_COMPOUND))
			lastAnimation = new ActiveAnimation(provider, this, tag.getCompound("Last"), query);
		else lastAnimation = null;
		
		if(tag.contains("Current", Tag.TAG_COMPOUND))
			currentAnimation = new ActiveAnimation(provider, this, tag.getCompound("Current"), query);
