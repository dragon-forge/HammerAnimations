		...
		extends IGenericModel
{
	IPositionalModel EMPTY = new IPositionalModel()
	{
		...
		@Override
		public boolean applyBoneTransforms(@NotNull Matrix4f base, String bone)
		{
			return false;
		}
	 ...
	 */
	boolean applyBoneTransforms(@NotNull Matrix4f base, String bone);
	 ...
	 * @return true when the bone is found.
	 */
	boolean applyBoneTransforms(@NotNull Matrix4d base, String bone);
	 ...
	 */
	boolean applyLocatorTransforms(@NotNull Matrix4f base, String locator);
	 ...
	 * @return true when the locator is found.
	 */
	boolean applyLocatorTransforms(@NotNull Matrix4d base, String locator);
}