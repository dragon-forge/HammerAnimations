package org.zeith.hammeranims.core.asm.tfs;

import org.objectweb.asm.Opcodes;
import org.objectweb.asm.tree.*;
import org.zeith.hammeranims.core.asm.ClassTransformer;
import org.zeith.hammeranims.core.asm.CoreClassTransformer;
		...
		extends ClassTransformer
{
	...
	public void processGetPrevPrevPos(MethodNode method, String axis)
	{
		...
		System.out.println("HammerAnimationsCore: patched getPrevPrevPos" + axis + "!");
	}
}