		...
		implements IParticleRender
{
	...
	@Override
	public void render(ParticleVariables vars, ParticleEmitter emitter, BedrockParticle particle, IVertexBuilder builder, MatrixStack pose, float partialTicks)
	{
		this.renderOnScreen(vars, particle, builder, pose, 0, 0, 0, 0);
	}
	
	@Override
	public void renderOnScreen(ParticleVariables vars, BedrockParticle particle, IVertexBuilder builder, MatrixStack pose, int x, int y, float scale, float partialTicks)
	{
		if(this.color != null)
		{
