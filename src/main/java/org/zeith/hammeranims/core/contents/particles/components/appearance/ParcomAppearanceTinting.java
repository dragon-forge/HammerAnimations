		...
		implements IParticleRender
{
	...
	@Override
	public void render(ParticleVariables vars, ParticleEmitter emitter, BedrockParticle particle, IVertexOutput builder, float partialTicks)
	{
		this.renderOnScreen(vars, particle, 0, 0, 0, 0);
	}
	
	@Override
	public void renderOnScreen(ParticleVariables vars, BedrockParticle particle, int x, int y, float scale, float partialTicks)
	{
		if(this.color != null)
		{
