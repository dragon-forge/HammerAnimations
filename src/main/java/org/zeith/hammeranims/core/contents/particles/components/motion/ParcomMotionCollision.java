...
{
	public LzFactory enabled = InterpolatedDouble.one();
	...
	public LzFactory expirationDelay = InterpolatedDouble.zero();
	...
	{
		return new ParcomMotionCollisionInstance(
				this,
				vars
		);
	}
	...
	public static class ParcomMotionCollisionInstance
			implements IParticleUpdate
	{
		public final LzExpression enabled;
		public final boolean preserveEnergy;
		public final boolean entityCollision;
		public final boolean momentum;
		public final float collisionDrag;
		public final float bounciness;
		public final float randomBounciness;
		public final float randomDamp;
		public final float damp; // should be like in Blender
		public final int splitParticleCount;
		public final float splitParticleSpeedThreshold; // threshold to activate the split
		public final float radius;
		public final boolean expireOnImpact;
		public final LzExpression expirationDelay;
		public final boolean realisticCollision;
		public final boolean realisticCollisionDrag;
		public final float rotationCollisionDrag;
		...
		public ParcomMotionCollisionInstance(ParcomMotionCollision o, LzVariableStore vars)
		{
			this.enabled = o.enabled.instantiate(vars);
			this.preserveEnergy = o.preserveEnergy;
			this.entityCollision = o.entityCollision;
			this.momentum = o.momentum;
			this.collisionDrag = o.collisionDrag;
			this.bounciness = o.bounciness;
			this.randomBounciness = o.randomBounciness;
			this.randomDamp = o.randomDamp;
			this.damp = o.damp;
			this.splitParticleCount = o.splitParticleCount;
			this.splitParticleSpeedThreshold = o.splitParticleSpeedThreshold;
			this.radius = o.radius;
			this.expireOnImpact = o.expireOnImpact;
			this.expirationDelay = o.expirationDelay.instantiate(vars);
			this.realisticCollision = o.realisticCollision;
			this.realisticCollisionDrag = o.realisticCollisionDrag;
			this.rotationCollisionDrag = o.rotationCollisionDrag;
		}
		...
		public void update(ParticleEmitter emitter, BedrockParticle particle)
		{
			...
			if(!particle.manual && this.enabled.get() > 0)
			{
		...
		public void drag(BedrockParticle particle)
		{
			...
			if(!((this.randomBounciness != 0 || this.realisticCollision) && Math.round(particle.speed.x * 10000) == 0 && Math.round(particle.speed.y * 10000) == 0 &&
