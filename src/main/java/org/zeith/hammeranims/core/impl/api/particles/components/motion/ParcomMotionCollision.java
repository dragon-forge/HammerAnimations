package org.zeith.hammeranims.core.impl.api.particles.components.motion;
		...
		implements IParticleUpdate
{
	...
	public static double calculateXOffset(AxisAlignedBB thiz, AxisAlignedBB other, double offsetX)
	{
	...
	public static double calculateYOffset(AxisAlignedBB thiz, AxisAlignedBB other, double offsetY)
	{
	...
	public static double calculateZOffset(AxisAlignedBB thiz, AxisAlignedBB other, double offsetZ)
	{
