package org.zeith.hammeranims.standalone.mc;
...
public class FastColor
{
	...
	public static class ARGB32
	{
		...
		{
			int i = lerpInt(pDelta, alpha(pMin), alpha(pMax));
			int j = lerpInt(pDelta, red(pMin), red(pMax));
			int k = lerpInt(pDelta, green(pMin), green(pMax));
			int l = lerpInt(pDelta, blue(pMin), blue(pMax));
