package org.zeith.hammer.models.api.animation;
...
import org.zeith.hammer.models.core.impl.api.animation.AnimationContainerImpl;

/**
 * Represents a container for animations in Hammer Models.
 * <p>
 * Animation containers may be registered in a simple way:
 * - Annotate your class with all animations with @{@link org.zeith.hammer.models.api.annotations.RegisterAnimations}
 * - Declare static final IAnimationContainer constants, annotate each one with @{@link org.zeith.hammer.models.api.annotations.AnimKey}
