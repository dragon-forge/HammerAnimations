...
{
	public JSONObject getAsJsonObject(String item)
	{
		return getJSONObject(item);
	}
...
// Shave off trailing zeros and decimal point, if possible.
	 ...
	 * 		default value to return is the conversion doesn't work or is null.
	 * @param exact
	 * 		When <code>true</code>, then {@link Double} and {@link Float} values will be converted exactly.
	 ...
	 * @param w
	 * 		The Writer to which the quoted string will be appended.
	 *
